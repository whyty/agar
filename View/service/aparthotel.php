...
echo "<img class='banner_service' src='".URL."public/images/bannere/banner_aparthotel.jpg' alt=''>"; ?>
...
<div class='content_body'>
	...
	echo "<a href='http://rentintm.com' target='_blank'><img class='image_link_image' src='".URL."public/images/additional_images/apartamente.png' alt=''></a>"; 
	echo "<div class='image_link_text3'><a href='http://rentintm.com' target='_blank'>REZERVA</br> APARTAMENT</a></div>"; 
	echo "</div>";
	echo "</div>";
